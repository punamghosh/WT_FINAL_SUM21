	...
	<table border="1" width="100%" cellpadding="10">
		...
		<tr height="360px">
			...
			<td align="center" bgcolor="dimgray">
				...
				$i=0;
				$userDatas = fetchSellers($conn);
				if (count($userDatas)==0) {
					echo "<tr><td colspan='6' align='center'>No seller found...</td></tr>";
				}
				...
				?>
					<tr>
						...
						<td><a href="Controllers/active_account.php?sellerId=<?=$userData['id']?>">Active</a> | <a href="Controllers/disable_account.php?sellerId=<?=$userData['id']?>">Disable</a></td>
					</tr>
				<?php } ?>
				</table>
