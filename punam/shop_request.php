	...
	<table border="1" width="100%" cellpadding="10">
		...
		<tr height="360px">
			...
			<td align="center" bgcolor="dimgray">
				...
				$i=0;
				$shopDatas = fetchShops($conn, null, true);
				if (count($shopDatas)==0) {
					echo "<tr><td colspan='5' align='center'>No shop request found...</td></tr>";
				}
				...
				?>
					<tr>
						...
						<td><a href="Controllers/shop.php?approveId=<?=$shopData['id']?>">Approve</a> | <a href="Controllers/shop.php?deleteId=<?=$shopData['id']?>">Delete</a></td>
					</tr>
				<?php } ?>
				</table>
