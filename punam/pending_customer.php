	...
	<table border="1" width="100%" cellpadding="10">
		...
		<tr height="360px">
			...
			<td align="center" bgcolor="dimgray">
				...
				$i=0;
				$userDatas = fetchCustomers($conn, null, true);
				if (count($userDatas)==0) {
					echo "<tr><td colspan='5' align='center'>No pending customer found...</td></tr>";
				}
				...
				?>
					<tr>
						...
						<td><a href="Controllers/approve_account.php?customerId=<?=$userData['id']?>">Approve</a> </td>
					</tr>
				<?php } ?>
				</table>
